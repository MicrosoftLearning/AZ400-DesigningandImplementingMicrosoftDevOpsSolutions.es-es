...
9. En la hoja **Application Insights**, selecciona **Activar Application Insights**.
...
15. En la hoja **Crear una regla de alertas**, en la sección **Condición**, deja el **Umbral** establecido en ** Estático** y valida la otra configuración predeterminada de la siguiente manera:
...
15. En la lista desplegable **Nombre del Servicio de aplicaciones**, selecciona el nombre de la aplicación web **Prod**.
...
20. En el panel **Ejecutar canalización**, acepta la configuración predeterminada y haz clic en **Ejecutar** para crear la canalización. **Espera a que finalice la compilación de la canalización**.
...
22. En la hoja **eshoponweb-cd > Release-1**, realiza un seguimiento del progreso de la versión y comprueba que la implementación en ambas aplicaciones web se haya completado correctamente.
23. Cambia a la interfaz de Azure Portal, ve al grupo de recursos **az400m04l09-RG** y en la lista de recursos, haz clic en la aplicación web **DevTest**. En la hoja de la aplicación web, haz clic en **Examinar** y comprueba que la página web (sitio web de comercio electrónico) se cargue correctamente en una nueva pestaña del explorador web.
24. Vuelve a la interfaz de Azure Portal. Esta vez, ve al grupo de recursos **az400m04l09-RG** y, en la lista de recursos, haz clic en la aplicación web **Producción**. En la hoja de la aplicación web, haz clic en **Examinar** y comprueba que la página web se cargue correctamente en una nueva pestaña del explorador web.
25. Cierra la pestaña del explorador web que muestra el sitio web **EShopOnWeb**.
...
3. En el panel **Condiciones previas a la implementación**, coloca el control deslizante **Aprobaciones previas a la implementación** en **Habilitado** y, en el cuadro de texto **Aprobadores**, escribe y selecciona el nombre de la cuenta de Azure DevOps.
...
7. Verás que la fase **DevTest** está en estado **Pendiente de aprobación**. Haz clic en el botón **Aprobar**. Esto vuelve a activar DevTest Stage.
...
2. En el panel **Condiciones posteriores a la implementación**, coloca el control deslizante **Validaciones** en **Habilitado**, haz clic en **+ Agregar** y, en el menú emergente, haz clic en **Consultar alertas de Azure Monitor**.
...
4. En el panel **Condiciones posteriores a la implementación**, expande la sección **Opciones avanzadas** y configura las siguientes opciones:
...
5. En el panel **Condiciones posteriores a la implementación**, expande **Opciones de evaluación** y configura estas opciones:
...
7. Cuando vuelvas al panel **eshoponweb-cd**, haz clic en **Guardar** y, en el cuadro de diálogo **Guardar**, haz clic en **Aceptar**.
...
4. En Azure Portal, en el campo "Buscar recursos, servicios y documentos", escribe **Application Insights** y selecciona el recurso **DevTest-AppInsights** creado en el ejercicio anterior. Ahora ve a **Alertas**.
...
6. Ten en cuenta que debe haber al menos **1** alerta con error marcada con **Gravedad 2: advertencia** en la lista. Esto se desencadena al validar la dirección URL no existente del sitio web en el ejercicio anterior.
...
9. Espera a que se inicie la canalización de versión y **aprueba** la acción de versión de DevTest Stage.
10. Espera a que la fase de lanzamiento de DevTest se complete correctamente. Observa cómo la opción **Validaciones posteriores a la implementación** cambia a un estado **Validaciones de evaluación**.  Haz clic en el icono **Validaciones de evaluación**.
11. Para **Consultar las alertas de Azure Monitor**, observa un estado de error inicial.
12. Deja la canalización de versión en un estado pendiente durante los próximos 5 minutos. Una vez transcurridos los 5 minutos, observa que la segunda evaluación de nuevo presenta un error.
13. Este es el comportamiento previsto, ya que hay una aplicación alerta de Application Insights desencadenada para la aplicación web DevTest.
